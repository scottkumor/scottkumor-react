...
const About = () => (
    ...
    <>
        {/* <div className="aboutWrap">
            <img className="" title="About Page" alt="About"
            ...
            <div className="">
                I hold a Bachelors of Business Administration in Information Systems from the
            ...
            <div className="">
                ...
                I am also a skiier, snowboarder, and skateboarder, and enjoy playing golf and tennis.
                </div>
        </div> */}
